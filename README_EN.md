...
This development mirror is maintained by [ch7696](https://github.com/ch7696), based on upstream [AIMixer/ComfyUI_MiniMaxH3_Director](https://github.com/AIMixer/ComfyUI_MiniMaxH3_Director).

- **Maintained fork:** [ch7696/ComfyUI_MiniMaxH3_Director](https://github.com/ch7696/ComfyUI_MiniMaxH3_Director)
- **Version note:** upstream `main` was synced first; this round of performance work and future development is maintained by `ch7696`.
...
This version was updated by GitHub user [ch7696](https://github.com/ch7696). It preserves the upstream feature set and adds:

- sequential decoding for nearby timeline video frames to reduce repeated random seeks;
...
3. Enter `https://github.com/ch7696/ComfyUI_MiniMaxH3_Director.git` and install
4. Restart ComfyUI
...
| | |
|---|---|
| **Current maintainer** | [ch7696](https://github.com/ch7696) |
| **This update** | `ch7696`: upstream sync and performance optimization |
| **Upstream author / maintainer** | [AIMixer](https://github.com/AIMixer) |
| **Maintained fork** | [github.com/ch7696/ComfyUI_MiniMaxH3_Director](https://github.com/ch7696/ComfyUI_MiniMaxH3_Director) |
